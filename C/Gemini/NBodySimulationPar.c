...
// Function to perform one kick-step (parallelized)
...
// Function to perform one full first-order kick-step (parallelized)
...
// Function to free the memory allocated for the system (no need for parallelization here)
