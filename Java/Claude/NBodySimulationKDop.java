...
public class NBodySimulation {
    ...
    // Cache tree between time steps if body positions haven't moved significantly
    private KDNode cachedTree;
    private int treeRebuildInterval = 5; // Rebuild tree every X steps
