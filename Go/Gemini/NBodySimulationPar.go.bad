...
// calculateTotalEnergy calculates the total energy of the system using goroutines.
...
// kickStep performs the "kick" part of the first-order kick-step method (parallelized with go-parallel).
