...
def compute_accelerations(positions, masses, mass_central):
    ...
    for i in range(num_bodies):
        ...
        for j in range(num_bodies):
            if i != j:
                ...
                accelerations[i] += accel_interbody
    
    return accelerations

# Perform the simulation using the kick-step method
def run_simulation(positions, velocities, masses, mass_central, num_steps, time_step):
    ...
    for step in range(num_steps):
        ...
        accelerations = compute_accelerations(positions, masses, mass_central)
